...
import com.davega.ui.core.fragment.OnBackPressedFragment
import com.google.android.material.bottomsheet.BottomSheetDialog

/**
 * Obtiene un [Lazy] que proporciona un [OnBackPressedCallback] personalizado para gestionar el evento de retroceso
 * (onBackPressed) en el fragmento actual, si este fragmento implementa la interfaz [OnBackPressedFragment].
 *
 * @return Un objeto [Lazy] que proporciona el [OnBackPressedCallback] personalizado cuando sea necesario.
 */
